...
router.post('/signin', async (req, res) => {
  try {
    ...
    const results = await pool.query('SELECT user_id, name, password, email, birthdate, height, activity, gender FROM COACHIFY.User WHERE email = $1 AND password = $2', [email, password]);
